...
G3DMassDiffCoreDouble::G3DMassDiffCoreDouble(AbstractNBodyEngine<double>* const engine, QObject* parent)
    : AbstractEngineCoreDouble(engine, parent)
{

}

void G3DMassDiffCoreDouble::calculateTimeProgress(int threadNumber) const
{
...
void G3DMassDiffCoreDouble::calculateInteraction(int threadNumber) const
{

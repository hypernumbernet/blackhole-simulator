...
G3DMassDiffCoreSingle::G3DMassDiffCoreSingle(G3DMassDiffNBE<float>* const engine, QObject* parent)
...
void G3DMassDiffCoreSingle::calculateTimeProgress(int threadNumber) const
{
    m_e->calculateTimeProgress(threadNumber);
    //(m_engine->*p_calculateTimeProgress)(threadNumber);
...
void G3DMassDiffCoreSingle::calculateInteraction(int threadNumber) const
{
    m_e->calculateInteraction(threadNumber);

...
template <typename T>
G3DMassDiffNBE<T>::G3DMassDiffNBE(
...
template <typename T>
void G3DMassDiffNBE<T>::calculateTimeProgress() const
{
    //debug();
...
template <typename T>
void G3DMassDiffNBE<T>::calculateInteraction() const
{
...
template <typename T>
void G3DMassDiffNBE<T>::debug() const
{
...
template <typename T>
void G3DMassDiffNBE<T>::setTimePerFrame(const T time)
{
    m_timePerFrame = time;

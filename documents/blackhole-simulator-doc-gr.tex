...
\begin{equation}
  ...
  \left\{
    \begin{aligned}
      &x' = x + (z u_2 - y u_3) \sin \phi + ( - 2 x (u_1^2 - 1) + 2 (y u_1 u_2 + z u_1 u_3)) \sin^2 \frac{\phi}{2} \\
      &y' = y + (x u_3 - z u_1) \sin \phi + ( - 2 y (u_2^2 - 1) + 2 (x u_1 u_2 + z u_2 u_3)) \sin^2 \frac{\phi}{2} \\
      &z' = z + (y u_1 - x u_2) \sin \phi + ( - 2 z (u_3^2 - 1) + 2 (x u_1 u_3 + y u_2 u_3)) \sin^2 \frac{\phi}{2} \\
    \end{aligned}
  \right.
\end{equation}
\begin{equation}
  ...
  \left\{
    \begin{aligned}
      &x' = x + (z u_2 - y u_3) \sin \phi + 2 (x (1 - u_1^2) + y u_1 u_2 + z u_1 u_3) \sin^2 \frac{\phi}{2} \\
      &y' = y + (x u_3 - z u_1) \sin \phi + 2 (y (1 - u_2^2) + x u_1 u_2 + z u_2 u_3) \sin^2 \frac{\phi}{2} \\
      &z' = z + (y u_1 - x u_2) \sin \phi + 2 (z (1 - u_3^2) + x u_1 u_3 + y u_2 u_3) \sin^2 \frac{\phi}{2} \\
    \end{aligned}
  \right.
\end{equation}
